...
LANGUAGES = {
    "日本語": {
        ...
        "tab3": {
            ...
            "format_type_item0": "0: フォーマット無し",
            "format_type_item1": "1: 半角スペースを一部削除",
            "format_type_item2": "2: 余分な改行を一部削除",
            "format_type_item3": "3: 半角スペースと余分な改行を一部削除",
            "format_type_item4": "4: 半角スペースの一部と余分な改行を全て削除",
