...
LANGUAGES = {
    "日本語": {
        ...
        "tab1_subheader": "設定ファイルとテンプレートを使ったテキスト整形",
        "tab1_upload_config": "設定ファイルをアップロード",
        "tab2_upload_debug_config": "設定ファイルをアップロード",
        "tab1_upload_template": "Jinjaテンプレートをアップロード",
        ...
        "tab2_subheader": "設定ファイルの構文解析",
        "tab2_debug_config_text": "設定ファイルの解析結果",
        "tab2_success_debug_config": "設定ファイル解析に成功",
        "tab2_error_debug_config": "設定ファイルの読み込みに失敗",
        "tab2_error_debug_not_found": "設定ファイルが読み込まれていません",
        ...
        "tab3_subheader_input_file": "入力ファイルの設定",
        "tab3_subheader_output_file": "出力ファイルの設定",
