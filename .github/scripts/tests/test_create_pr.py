...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(["git", "status"], True, id="git statusが有効なコマンドの場合"),
        pytest.param(["npm", "version"], True, id="npm versionが有効なコマンドの場合"),
        pytest.param(["jq", "."], True, id="jq .が有効なコマンドの場合"),
        ...
        pytest.param(["echo", "hello", "|", "grep", "hello"], False, id="echo hello | grep helloが無効なコマンドの場合"),
